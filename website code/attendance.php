        ...
        <div id="page-wrapper">
            ...
            <div class="row">
               ...
               <div class="panel-body">
                ...
                <div id="report"> 
                   <a href="index_s.php" style="align:center"><input type="button" class="btn btn-primary" value="Back"  style="width:20%;height:6%; background-color:#007acc; color:white "></a>
                </div>
        </div>
