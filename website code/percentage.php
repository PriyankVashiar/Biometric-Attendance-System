...
<body>
   ...
   if(isset($_POST['search']))
   {
        ...
        echo"<tr cellspadding='5'><center><h3>Attendance status of subject $sub from class $class</h3></center></tr>";
        echo"<tr>                   
                    <td>Roll No</td>
                    <td>Total Present</td>
        ...
        while($res=mysqli_fetch_assoc($final_res))
          ...
          $pp=$c-1;
            ...
            $row=mysqli_query($con,"select * from $done where month(date)='$month'");
                $final_row=mysqli_num_rows($row);
                
                echo "<center><h3>Total Lecture complete of <b>$month/$year: $final_row</b> </h3></center>";
              ...
              $count=0;
                ...
                while($count<$pp) {
                    ...
                    $ans[$p]=0;
                        ...
                        while($res1=mysqli_fetch_array($final_res))
                        {
                            
                            $ans[$p]=$ans[$p]+$res1[$count+1];
                        ...
                        echo"<tr><td> $id_no </td><td>";

                            

                                echo $ans[$p]; 
                                
                                $rasio=((intval($ans[$p]))*100)/$final_row;
                                if($rasio<75){
                                    $status_of_attendance="Low";
                                }
                           
                               
                            echo"</td><td> $rasio %</td> <td>  <b style='color:red;'>$status_of_attendance</b></td> 
