                           ...
                           <fieldset>
								<div class="form-group" style="text-align:center">
                                   <table border="0" width="100%"><tr><td> 
                                        <select name="month" id="month"  class="form-control" style="text-align:center; width:60%; align:center">
                                       ...
                                       <td>
                                       <td>
                                           <select name="sub" class="form-control" style="text-align:center; width:60%; align:center">
                                       ...
                                       <td>
                                        ...
                                        <input type="submit" value="Submit" name="submit"  class="btn btn-primary" style="text-align:center; width:100%; ">
                                       </td></tr>
                                   </table>
                                </div>
                           </fieldset>
